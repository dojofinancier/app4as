...
export default function CartError({
  ...
  useEffect(() => {
    ...
    import('@/lib/utils/error-logging').then(({ logClientError }) => {
      logClientError(
        error.message || 'Une erreur est survenue avec le panier',
        error.stack,
        {
        ...
        <Card className="w-full max-w-md">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <CardTitle>Erreur avec le panier</CardTitle>
            </div>
            <CardDescription>
              Désolé, une erreur est survenue lors du chargement de votre panier.
            </CardDescription>
          </CardHeader>
