...
### 0. **[DOCUMENTATION_GUIDE.md](./DOCUMENTATION_GUIDE.md)** 📖 DOCUMENTATION GUIDE
**How to document development decisions and context.**

Contains:
- Architecture Decision Records (ADRs) guidance
- CHANGELOG.md best practices
- Decision Log for quick decisions
- In-code documentation guidelines
- When to use each documentation method

**Use this for:** Understanding how to document decisions going forward
